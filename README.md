...
- **Linked Navigation** -- Click relative `.md` links to open them as new tabs (wiki-style browsing); a link to a directory (`docs/routing/`) opens that directory's `README.md`
